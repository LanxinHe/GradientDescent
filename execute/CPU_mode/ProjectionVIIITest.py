...
from model.CPU_model import ProjectionVIII
import torch
...
if __name__ == '__main__':
    ...
    #                                                                                                         RNN_HIDDEN_SIZE,
    #                                                                                                         STEP_SIZE)
    detnet = ProjectionVIII.DetModel(TX, RNN_HIDDEN_SIZE, PROJECT_TIMES)
    ...
    with torch.no_grad():
        ...
        for ebn0 in TEST_EBN0:
            ...
            with torch.no_grad():
                ...
                BER += [ber]
    # --------------------------------------- Save Model & Data --------------------------------------------------------
    PATH = '../../pretrained_projectionVIII/tx%i/rx%i/rate%i/EBN0_Train%i/iterations%i/project_times%i/batch_size%i/rnn_hidden_size%i/step_size%.5f' % (TX, RX, RATE,
                                                                                                            EBN0_TRAIN,
                                                                                                            ITERATIONS,
                                                                                                            PROJECT_TIMES,
                                                                                                            BATCH_SIZE,
