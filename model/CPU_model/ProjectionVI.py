...
"""
In this Module, we rewrite DetNet by utilizing RNNCell in PyTorch while only project ONCE at last (MMSE) and use 'tanh'
"""
...
class RecurrentCell(nn.Module):
    def __init__(self, tx, hidden_size):
        ...
        self.rnn = nn.RNNCell(2*tx, hidden_size)
